...
public interface BookSearchControllerDocs {
	...
	Page<JpaGetBookSearchResponse> searchByKeyword(@RequestParam String title, Pageable pageable);
	...
	@Parameter(name = "pageable", description = "페이지 정보", required = true)
	Page<JpaGetBookSearchResponse> searchByAuthor(@RequestParam String author, Pageable pageable);
	...
	@Parameter(name = "pageable", description = "페이지 정보", required = true)
	Page<JpaGetBookSearchResponse> searchByPublish(@RequestParam String publish, Pageable pageable);
	...
	@Parameter(name = "pageable", description = "페이지 정보", required = true)
	Page<JpaGetBookSearchResponse> searchByCategory(@RequestParam String category, Pageable pageable);
}
